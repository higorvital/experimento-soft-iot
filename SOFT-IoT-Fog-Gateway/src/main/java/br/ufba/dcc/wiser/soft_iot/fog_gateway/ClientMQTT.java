...
public class ClientMQTT implements MqttCallbackExtended {
	...
	public void gatewayConnectedMessage(String ip, String port, int qtdGatewayDevices) {
		byte[] b = (ip+" - "+port+" - "+qtdGatewayDevices).getBytes();
		publicar("GATEWAY_CONNECTED", b, 1);
