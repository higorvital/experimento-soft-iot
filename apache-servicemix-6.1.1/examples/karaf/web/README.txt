...
[uninstalled] [3.0.6 ] wrapper           standard-3.0.6      Provide OS integration
[uninstalled] [3.0.6 ] obr               standard-3.0.6      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [3.0.6 ] config            standard-3.0.6      Provide OSGi ConfigAdmin support
[uninstalled] [3.0.6 ] region            standard-3.0.6      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-3.0.6      Provide Jetty engine support
[uninstalled] [3.0.6 ] http              standard-3.0.6      Implementation of the OSGI HTTP Service
[uninstalled] [3.0.6 ] http-whiteboard   standard-3.0.6      Provide HTTP Whiteboard pattern support
[uninstalled] [3.0.6 ] war               standard-3.0.6      Turn Karaf as a full WebContainer
[uninstalled] [3.0.6 ] deployers         standard-3.0.6      Provide Karaf deployer
[uninstalled] [3.0.6 ] kar               standard-3.0.6      Provide KAR (KARaf archive) support
[uninstalled] [3.0.6 ] webconsole-base   standard-3.0.6      Base support of the Karaf WebConsole
[uninstalled] [3.0.6 ] webconsole        standard-3.0.6      Karaf WebConsole for administration and monitoring
[uninstalled] [3.0.6 ] ssh               standard-3.0.6      Provide a SSHd server on Karaf
...
Maven builds the web application, web-3.0.6.war, and
